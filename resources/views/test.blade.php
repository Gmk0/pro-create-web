...
<body class="home-14">
                ...
                <div class="w-full custom-md:w-7/12">
                    <div class="topbar__list-wrapper">
                        <ul class="topbar__list">
                            <li class="!hidden custom-lg:!flex">Consult With It Advisor? <a href="index.html">Click
                                    Now</a>
                            </li>
                            <li><a href="mailto:support@example.com"><i
                                        class="fas fa-envelope"></i>support@example.com</a>
                            </li>
    ...
    <nav class="navbar navbar-area navbar-area-2 navbar-expand-lg bg-white !mt-0">
        <div class="container nav-container custom-container">
            <div class="responsive-mobile-menu">
                <button class="menu toggle-btn block custom-md:hidden" data-target="#itech_main_menu"
   ...
   <div class="banner-14 banner-area bg-relative banner-area-1 pd-bottom-100 bg-cover bg-center bi-26">
            ...
            <div class="w-full custom-md:w-8/12 custom-lg:w-6/12">
                <div class="banner-inner">
                    ...
                    <h2 class="title wow animated fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.6s">
                        <span>Des solutions digitales efficaces</span>
                        pour une <span>entreprise performante</span>
                    </h2>
                    <p class="content custom-lg:pe-[48px] wow animated fadeInLeft" data-wow-duration="0.8s"
                        data-wow-delay="0.9s">
                        Dans le monde des affaires compétitif d'aujourd'hui, la demande de solutions informatiques
                        efficaces et rentables n'a jamais été aussi cruciale.
                    </p>
                    <a class="btn btn-base wow animated fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.6s"
                        href="about.html">Commencer</a>
                    <div class="inline-block self-center wow animated fadeInLeft" data-wow-duration="0.8s"
                        ...
                        <a class="video-play-btn-hover !static" href="https://www.youtube.com/embed/Wimkqo8gDZ0">
                            ...
                            <h6 class="inline-block">Notre Méthode</h6>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-14-thumb">
        <img src="./images/home-14/banner/banner-thumb.png" alt="Image">
    </div>
    <div class="banner-13-thumb-sm">
        <img src="./images/home-14/banner/banner-shape.png" alt="Image">
    </div>
    <img src="./images/home-14/banner/fig.png" alt="Image" class="fig">
    <img src="./images/home-14/banner/sketch.png" alt="Image" class="sketch">
    <img src="./images/home-14/banner/triangle.png" alt="Image" class="triangle">
</div>
    <!-- banner end -->
    <!-- partner start -->
                    ...
                    <div class="partner__inner">
                        <div class="partner__slider owl-carousel">
                            <div class="partner__slider-single">
                                <img src="./images/home-14/partner/one.png" alt="Image">
                            </div>
                            <div class="partner__slider-single">
                                <img src="./images/home-14/partner/two.png" alt="Image">
                            </div>
                            <div class="partner__slider-single">
                                <img src="./images/home-14/partner/three.png" alt="Image">
                            </div>
                            <div class="partner__slider-single">
                                <img src="./images/home-14/partner/four.png" alt="Image">
                            </div>
                            <div class="partner__slider-single">
                                <img src="./images/home-14/partner/five.png" alt="Image">
                            </div>
                            <div class="partner__slider-single">
                                <img src="./images/home-14/partner/six.png" alt="Image">
                            </div>
                            <div class="partner__slider-single">
                                <img src="./images/home-14/partner/one.png" alt="Image">
                            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="custom-md:w-1/2">
                <div class="about-thumb-inner custom-lg:pe-[48px] custom-lg:me-[48px] wow animated fadeInLeft"
                    data-wow-duration="0.8s" data-wow-delay="0.3s">
                    <img class="animate-img-1 animate-topImageBounce" src="./images/about/2.png" alt="img">
                    <img class="animate-img-2 animate-leftImageBounce" src="./images/about/3.png" alt="img">
                    <img class="animate-img-3 animate-topImageBounce" src="./images/banner/5.svg" alt="img">
                    <img class="animate-img-3 ac-5 animate-topImageBounce" src="./images/about/34.png" alt="img">
                    <img class="animate-img-3 ac-6 animate-topImageBounce" src="./images/about/35.png" alt="img">
                    <img class="main-img" src="./images/about/about-14.png" alt="img">
                </div>
            </div>
            <div class="custom-md:w-1/2 wow animated fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.3s">
                <div class="section-title mt-[48px] mb-0 custom-md:mt-0">
                    <h6 class="sub-title uppercase">Concevoir pour l'avenir</h6>
                    <h2 class="title"><span>Des solutions digitales efficaces</span>
                        pour une <span>entreprise performante</span>
                    </h2>
                    <p class="content !mb-[24px] custom-lg:!mb-[48px]">
                        Nous accompagnons les entreprises dans leur transformation digitale avec des stratégies
                        sur-mesure, performantes et innovantes.
                    </p>
                    <div class="row tr-g">
                        <div class="custom-sm:w-1/2 custom-md:w-full custom-2xl:w-6/12">
                            <div class="single-about-inner">
                                ...
                                <div class="details">
                                    <h5 class="font-bold ">Notre Ambition</h5>
                                    <p>Offrir des solutions digitales adaptées aux défis de demain.</p>
                                </div>
                            </div>
                        </div>
                        <div class="custom-sm:w-1/2 custom-md:w-full custom-2xl:w-6/12">
                            <div class="single-about-inner">
                                ...
                                <div class="details font-bold">
                                    <h5>Notre Mission</h5>
                                    <p>Accompagner les entreprises dans leur croissance grâce au digital.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="about-area-on">
                        <div class="about-si">
                            <p><i class="fas fa-check-circle"></i> Aucune surprise, transparence totale.</p>
                        </div>
                        <div class="about-si">
                            <p><i class="fas fa-check-circle"></i> Sécurité et performance garanties.</p>
                        </div>
                    </div>
                    <div class="about-area-of">
                        <div class="area-left">
                            <a class="btn btn-base mt-0 wow animated fadeInLeft" data-wow-duration="0.8s"
                                data-wow-delay="0.6s" href="about.html">Commencer</a>
                        </div>
                        <div class="area-right">
                            <div class="img-gp-wrap">
                                <div class="img-gp">
                                    <img src="./images/about/37.png" alt="Image">
                                    <img src="./images/about/38.png" alt="Image">
                                    <img src="./images/about/36.png" alt="Image">
                                </div>
                                <h5>2.3M+</h5>
                            </div>
                            <p class="mb-0">5000+ Avis clients satisfaits</p>
                        </div>
                    </div>
                </div>
            </div>
   ...
   <div class="service-area bg-relative pd-top-100">
    ...
    <div class="container">
        <div class="section-title text-center wow animated fadeInUp" data-wow-duration="0.8s">
            <h6 class="sub-title">Innovation et Performance</h6>
            <h2 class="title"><span>Boostez Votre Visibilité</span> avec Nos Solutions Digitales</h2>
        </div>
        <div class="row">
            <div class="custom-md:w-1/3 custom-sm:w-1/2">
                <div class="single-service-inner text-center wow animated fadeInUp" data-wow-duration="0.8s">
                    ...
                    <div class="details">
                        <h5><a href="service-details.html">Développement Web & Mobile</a></h5>
                        <p>Nous créons des applications performantes et intuitives pour garantir une expérience
            ...
            <div class="custom-md:w-1/3 custom-sm:w-1/2">
                <div class="single-service-inner text-center wow animated fadeInUp" data-wow-duration="0.8s"
                    ...
                    <div class="details">
                        <h5><a href="service-details.html">Stratégie & Marketing Digital</a></h5>
                        <p>Optimisez votre présence en ligne avec des campagnes performantes et un contenu impactant.
                        </p>
                        <a href="service-details.html">
                            En savoir plus
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="20" viewBox="0 0 34 20"
            ...
            <div class="custom-md:w-1/3 custom-sm:w-1/2">
                <div class="single-service-inner text-center wow animated fadeInUp" data-wow-duration="0.8s"
                    ...
                    <div class="details">
                        <h5><a href="service-details.html">Solutions E-commerce</a></h5>
                        <p>Développez votre boutique en ligne avec des outils performants et une stratégie efficace.</p>
                        <a href="service-details.html">
                            En savoir plus
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="20" viewBox="0 0 34 20"
                                fill="none">
        ...
        <div class="container">
            <div class="row pd-top-120">
                <div class="custom-lg:w-6/12 custom-md:w-1/2 custom-sm:w-8/12 order-lg-last hidden custom-md:block">
                    <div class="about-thumb-inner custom-md:pt-[16px] wow animated fadeInLeft" data-wow-duration="0.8s"
                        data-wow-delay="0.3s">
                        <img class="main-img" src="./images/faq/one.png" alt="img">
                        <img class="an-img animate-topImageBounce" src="./images/faq/two.png" alt="img">
                        <img class="an-img-two animate-topImageBounce" src="./images/faq/three.png" alt="img">
                    </div>
                </div>
                <div class="custom-lg:w-6/12 custom-md:w-1/2 wow animated fadeInUp" data-wow-duration="0.8s">
                    <div class="section-title !mb-0">
                        <h6 class="sub-title">Designing for the future</h6>
                        <h2 class="title"><span>We are Experts</span> Security
                            <span>& Data</span> Management
                        </h2>
                        <p class="content">In today's competitive business, the demand for efficient
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    <p>Accelerate innovation with world-class tech teams We'll
                                        match you to an entire remote team.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
    ...
    <div class="counter-area bg-relative bg-cover bg-center pd-top-110 pd-bottom-100">
        <div class="container pd-bottom-90">
            <div class="row">
                <div class="custom-sm:w-1/2 custom-md:w-1/4  wow animated fadeInUp" data-wow-duration="0.8s">
                ...
                <div class="custom-sm:w-1/2 custom-md:w-1/4  wow animated fadeInUp" data-wow-duration="0.8s"
                    ...
                    <div class="single-counter-inner">
                        <div class="thumb">
                            <img src="./images/icon/7.svg" alt="img">
                        </div>
                        <h2 class="text-white mt-[24px] mb-[8px]"><span class="counter">200</span>+</h2>
                        <p class="text-white">Team member</p>
                    </div>
                ...
                <div class="custom-sm:w-1/2 custom-md:w-1/4  wow animated fadeInUp" data-wow-duration="0.8s"
                    ...
                    <div class="single-counter-inner">
                        <div class="thumb">
                            <img src="./images/icon/8.svg" alt="img">
                        </div>
                        <h2 class="text-white mt-[24px] mb-[8px]"><span class="counter">200</span>+</h2>
                        <p class="text-white">Team member</p>
                    </div>
                ...
                <div class="w-full custom-lg:w-11/12">
                    <div class="row tc-p">
                        <div class="w-full custom-xs:w-6/12 custom-md:w-1/3 custom-lg:w-3/12">
                            <div class="case__single wow animated fadeInUp" data-wow-duration="0.8s">
                                <div class="thumb">
                                    <img src="./images/steps/one-l.png" alt="Image">
                                </div>
                                <div class="details">
                                    <div class="int">
                        ...
                        <div class="w-full custom-xs:w-6/12 custom-md:w-1/3 custom-lg:w-3/12">
                            <div class="case__single wow animated fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.3s">
                                <div class="thumb">
                                    <img src="./images/steps/two-l.png" alt="Image">
                                </div>
                                <div class="details">
                                    <div class="int">
                                        <h6><a href="about.html">It Managment system</a></h6>
                        ...
                        <div class="w-full custom-xs:w-6/12 custom-md:w-1/3 custom-lg:w-3/12">
                            <div class="case__single wow animated fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.6s">
                                <div class="thumb">
                                    <img src="./images/steps/three-l.png" alt="Image">
                                </div>
                                <div class="details">
                                    <div class="int">
                                        <h6><a href="about.html">It Managment system</a></h6>
                        ...
                        <div class="w-full custom-xs:w-6/12 custom-md:w-1/3 custom-lg:w-3/12">
                            <div class="case__single wow animated fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.9s">
                                <div class="thumb">
                                    <img src="./images/steps/four-l.png" alt="Image">
                                </div>
                                <div class="details">
                                    <div class="int">
                                        <h6><a href="about.html">It Managment system</a></h6>
        ...
        <div class="container">
            ...
            <div class="row tc-p">
                <div class="w-full custom-sm:w-1/2 custom-md:w-1/3">
                    <div class="total-single wow animated fadeInUp" data-wow-duration="0.8s">
                        <div class="thumb">
                            <img src="./images/steps/two.png" alt="Image">
                            <span>01</span>
                        </div>
                        <div class="content">
                ...
                <div class="w-full custom-sm:w-1/2 custom-md:w-1/3">
                    <div class="total-single wow animated fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                        <div class="thumb">
                            <img src="./images/steps/one.png" alt="Image">
                            <span>02</span>
                        </div>
                        <div class="content">
                ...
                <div class="w-full custom-sm:w-1/2 custom-md:w-1/3">
                    <div class="total-single wow animated fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                        <div class="thumb">
                            <img src="./images/steps/three.png" alt="Image">
                            <span>03</span>
                        </div>
                        <div class="content">
        ...
        <div class="container">
            <div class="contact-inner-1">
                <div class="row align-items-center tc-p">
                    <div class="custom-md:w-1/2 wow animated fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.3s">
                        <div class="contact-inner">
                            ...
                            <a class="btn btn-base btn-white wow animated fadeInLeft mt-[48px]" data-wow-duration="0.8s"
                                data-wow-delay="0.6s" href="about.html">Get Started</a>
                        </div>
                    </div>
                    <div class="custom-md:w-1/2 custom-lg:w-5/12 offset-xl-1 wow animated fadeInRight"
                        data-wow-duration="0.8s" data-wow-delay="0.3s">
                        <div class="section-title !mb-0">
                            ...
                            <form class="mt-[24px]">
                                <div class="row">
                                    ...
                                    <div class="w-full">
                                        <a class="btn btn-black mt-0 w-100 border-radius-5" href="index.html">Submit
                                            now</a>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="row bs-t">
                <div class="custom-sm:w-1/2 custom-md:w-1/4  custom-lg:w-3/12">
                    <div class="single-team-inner text-center wow animated fadeInUp" data-wow-duration="0.8s">
                        <div class="thumb">
                            <img src="./images/team/11.png" alt="img">
                ...
                <div class="custom-sm:w-1/2 custom-md:w-1/4  custom-lg:w-3/12">
                    <div class="single-team-inner text-center wow animated fadeInUp" data-wow-duration="0.8s"
                        data-wow-delay="0.3s">
                        <div class="thumb">
                            <img src="./images/team/12.png" alt="img">
                            <ul class="team-social-inner">
                                <li><a href="index.html"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="index.html"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="index.html"><i class="fab fa-youtube"></i></a></li>
                ...
                <div class="custom-sm:w-1/2 custom-md:w-1/4  custom-lg:w-3/12">
                    <div class="single-team-inner text-center wow animated fadeInUp" data-wow-duration="0.8s"
                        data-wow-delay="0.6s">
                        <div class="thumb">
                            <img src="./images/team/13.png" alt="img">
                            <ul class="team-social-inner">
                                <li><a href="index.html"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="index.html"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="index.html"><i class="fab fa-youtube"></i></a></li>
                ...
                <div class="custom-sm:w-1/2 custom-md:w-1/4  custom-lg:w-3/12">
                    <div class="single-team-inner text-center wow animated fadeInUp" data-wow-duration="0.8s"
                        data-wow-delay="0.9s">
                        <div class="thumb">
                            <img src="./images/team/14.png" alt="img">
                            <ul class="team-social-inner">
                                <li><a href="index.html"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="index.html"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="index.html"><i class="fab fa-youtube"></i></a></li>
    ...
    <div class="pricing-area pd-top-120 pd-bottom-90">
        <div class="container">
            ...
            <div class="row">
                <div class="custom-md:w-1/3 custom-sm:w-1/2">
                    <div class="single-pricing-inner style-3 pa-o wow animated fadeInUp" data-wow-duration="0.8s">
                ...
                <div class="custom-md:w-1/3 custom-sm:w-1/2">
                    <div class="single-pricing-inner style-3 price-active pa-t wow animated fadeInUp"
                        data-wow-duration="0.8s" data-wow-delay="0.3s">
                        <h2 class="mb-[16px]">$19 <sub>/mo</sub></h2>
                        <h5>Professional</h5>
                        <ul>
                ...
                <div class="custom-md:w-1/3 custom-sm:w-1/2">
                    <div class="single-pricing-inner style-3 pa-h wow animated fadeInUp" data-wow-duration="0.8s"
                        data-wow-delay="0.6s">
                        <h2 class="mb-[16px]">$19 <sub>/mo</sub></h2>
                        <h5>Enterprise</h5>
                        <ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="custom-md:w-1/2 custom-sm:w-1/2">
                    <div class="single-blog-list wow animated fadeInUp" data-wow-duration="0.8s">
                        <div class="thumb">
                            <img class="border-radius-5" src="./images/blog/4.png" alt="img">
                        </div>
                        <div class="details">
                ...
                <div class="custom-md:w-1/2 custom-sm:w-1/2">
                    <div class="single-blog-list wow animated fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                        <div class="thumb">
                            <img class="border-radius-5" src="./images/blog/5.png" alt="img">
                        </div>
                        <div class="details">
                            <ul class="blog-meta p-0">
                                <li> Blog</li>
    ...
    <footer class="footer-area bg-black bg-cover bg-center">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="custom-sm:w-1/2 custom-md:w-1/4 ">
                    <div class="widget widget_nav_menu wow animated fadeInUp" data-wow-duration="0.8s"
                        data-wow-delay="0.3s">
                            ...
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-body self-center">
                                        <div class="post-info mb-[8px]"><i class="far fa-calendar-alt"></i><span>january
                                                11,
                                                2023</span></div>
                                        <h6 class="title mb-0"><a href="blog-details.html">Social Media For Promote
                                                Business.</a>
                                        </h6>
                                    </div>
                                </div>
